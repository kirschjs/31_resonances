...
plot "full_rgm_potential_MaxMin.dat" u 1:2  ls 1 w l t "$R(\\textrm{barrier})$",\
     "full_rgm_potential_MaxMin.dat" u 1:4  ls 2 w l t "$R(\\textrm{valley})$"
