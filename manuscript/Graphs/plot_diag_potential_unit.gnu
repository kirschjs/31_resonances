...
#set ytics -1500,1500  format "$%g$" nomirror
...
plot "rgm_pot_full_diag_unitary.dat" u 1:($2/1)  ls 2 w l t "$\\Lambda=1.5~\\textrm{fm}^{-1}$",\
     "rgm_pot_full_diag_unitary.dat" u 1:($7/1)  ls 1 w l t "$\\Lambda=10~\\textrm{fm}^{-1}$",\
     "rgm_pot_full_diag_unitary.dat" u 1:($3/1)  ls 3 lw 1.0 dt (9,9,9,9) w l t "",\
     "rgm_pot_full_diag_unitary.dat" u 1:($4/1)  ls 3 lw 1.5 dt (6,6,6,6) w l t "",\
     "rgm_pot_full_diag_unitary.dat" u 1:($5/1)  ls 3 lw 2.0 dt (3,3,3,3) w l t "",\
     "rgm_pot_full_diag_unitary.dat" u 1:($6/1)  ls 3 lw 2.5 dt (1,1,1,1) w l t ""
