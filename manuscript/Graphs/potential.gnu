...
plot "tmp_VW.dat" u 1:2  ls 1 w l t "$\\lambda=0.5625~\\textrm{fm}^{-2}$",\
     "tmp_VW.dat" u 1:7  ls 2 w l t "$\\lambda=25~\\textrm{fm}^{-2}$",\
     "tmp_VW.dat" u 1:3  ls 3 w l t "",\
     "tmp_VW.dat" u 1:4  ls 3 w l t "",\
     "tmp_VW.dat" u 1:5  ls 3 w l t "",\
     "tmp_VW.dat" u 1:6  ls 3 w l t ""

set output
! latex tmp.tex && dvipdf tmp.dvi
! mv tmp.pdf rgm_potential.pdf
! rm tmp.*
